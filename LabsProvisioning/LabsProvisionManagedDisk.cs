...
{
    public static class LabsProvisionManagedDisk
    {
        [FunctionName("LabsProvisionManagedDisk")]
                    ...
                    case "WINDOWS":
                        {
                            if (isManaged)
                            {
                                ...
                                stream = new MemoryStream(Properties.Resources.azuredeploywindowsmanagedgallery);
